...
function BlogMain() {
    ...
    return (
        <div >
            <div className="container" data-testid="tornado">
                ...
                <div className="jumbotron p-4 p-md-5 text-black rounded" id={"jumbotron"}>
                    ...
                    how to prepare for, act during, and recover after a Tornado strikes.</p>
                        <p className="lead mb-0"><Link to="/blog/536308ed-22f7-4c82-a366-4617ede5f8ed" className="text-black font-weight-bold"
                            data-testid="tornadoLink">Continue reading...</Link>
                        </p>
                    </div>
                </div>

                <div className="row mb-2" data-testid="hurricane">
                    ...
                    how to prepare for, act during, and recover after a Hurricane strikes.</p>
                                ...
                                <Link to="/blog/f592d182-8e43-4a7f-817a-8b3ba9952b78" className="stretched-link"
                                    data-testid="hurricaneLink">Continue reading</Link>
                            </div>
                    ...
                    <div className="col-md-6" data-testid="earthquake">
                        <div
                            className="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                            <div className="col p-4 d-flex flex-column position-static" id={"featured"}>
                    ...
                    how to prepare for, act during, and recover after an Earthquake strikes.</p>
                                <Link to="/blog/a4913a0a-2c02-4a08-acbd-35ce8b027c62" className="stretched-link"
                                    data-testid="earthquakeLink">Continue reading</Link>
                            </div>
                            <div className="col-auto d-none d-lg-block">
            ...
            <main role="main" className="container">
                <div className="row">
                    <div className="col-md-8 blog-main">
                        ...
                        <div className="blog-post" data-testid="blizzard">
                    ...
                    how to prepare for, act during, and recover after a Blizzard strikes.</p>
                            ...
                            <Link to="/blog/35b19bf5-ea32-4f95-86bb-57384fd63048" className="stretched-link"
                                data-testid="blizzardLink">Continue reading here</Link>
                        </div>


                        <div className="blog-post" data-testid="flood">
                    ...
                    how to prepare for, act during, and recover after a Flood strikes.</p>
                            ...
                            <Link to="/blog/ef3efa7e-9a6a-4283-8c28-ec59205145a3" className="stretched-link"
                                data-testid="floodLink">Continue reading here</Link>

                        </div>


                        <div className="blog-post" data-testid="wildfire">
                    ...
                    how to prepare for, act during, and recover after a Wildfire strikes.</p>
                            ...
                            <Link to="/blog/9fb71b54-c879-49a6-810c-0620ce08eca9" className="stretched-link"
                                data-testid="wildfireLink">Continue reading here</Link>
                        </div>
                    ...
                    <aside className="col-md-4 blog-sidebar">
                        <div className="p-4 mb-3 bg-light rounded" data-testid="about">
